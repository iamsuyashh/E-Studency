...
# 1 img
        img = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\smart-attendance.jpg")
...
# 2 img
        img1 = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\student.jpg")
...
# 3 img
        img2 = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\stud.jpg")
        ...
        #Title
        title_lbl=Label(bg_img,text = "STUDENT MANAGEMENT",font=("Roboto",35,"bold"),bg="blue",fg="White")
        title_lbl.place(x=0,y=0,width=1530,height=45)

        # Creating Frame 
        main_frame = Frame(bg_img,bd=2,bg="white") #bd mean border 
        main_frame.place(x=5,y=55,width=1755,height=810)

        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("verdana",12,"bold"),fg="navyblue")
        left_frame.place(x=10,y=100,width=700,height=480)
        ...
        dep_combo["values"]=("Select Department","IF","ME","CO","CI","EJ")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","I","G")
        cou_combo.current(0)
        ...
        #update photo button
        update_photo_btn=Button(btn_frame,command=self.update_data,text="Update Pic",width=9,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        ...
        right_frame.place(x=780,y=100,width=700,height=480)
...
# Generating dataset for photo samples
    ...
    # ====================Loading images in predefined list==============
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        ...
                        file_path="dataimg/student."+str(id)+"."+str(img_id)+".jpg"
