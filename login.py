...
# bg img
        self.bg=ImageTk.PhotoImage(file=r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\loginbg.png")
...
# Logo immg
        img1=Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\logo.png")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            conn = mysql.connector.connect(username='root', password='PUBGsuyash123',host='localhost',database='facerecognition',port=3306)
...
# Varriablels
        ...
        self.bg=ImageTk.PhotoImage(file=r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\un.jpg")
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)
        
        self.bg1=ImageTk.PhotoImage(file=r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\facialrecognition (1).png")
...
# 1 img
        img = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\BestFacialRecognition.jpg")
...
# 2 img
        img1 = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\facialrecognition.png")
...
# 3 img
        img2 = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\images.jpg")
        ...
        # Backgrond img
        bg = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\bgimg.jpg")
...
# student buttons
        stud = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\student.jpg")
...
# Detect Face button    
        dect = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\face_detector1.jpg")
...
# attendance button
        attd = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\attendance.jpg")
...
# Help button        
        hlp = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\help.jpg")
...
# Train face button
        trn = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\train.jpg")
...
# Photos face button
        pic = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\people.jpg")
...
# Developers
        dev = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\dev.jpg")
...
# Exit buttton
        ex = Image.open(r"D:\FINAL YEAR PROJECT\face_recognition_system\college_images\exit.jpg")
